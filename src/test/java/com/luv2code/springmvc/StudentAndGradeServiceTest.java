...
public class StudentAndGradeServiceTest {
    ...
    public void createStudentService(){
        ...
        CollegeStudent student = studentDao.findByEmailAddress("chad@example.com");
    ...
    public void deleteStudentService() {
        ...
        assertFalse(deleteCollegeStudent.isPresent());
    ...
    public void studentInformation() {
        ...
        assertEquals("eric@example.com", gradebookCollegeStudent.getEmailAddress());

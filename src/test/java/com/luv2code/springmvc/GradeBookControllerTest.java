...
public class GradeBookControllerTest {
    ...
    public void getStudentsHttpRequest() throws  Exception {
        CollegeStudent studentOne = new GradebookCollegeStudent("Eric", "Roby", "eric@example.com");
        CollegeStudent studentTwo = new GradebookCollegeStudent("Yuya", "Mori", "yuya@example.com");
    ...
    @Test
    public void creteStudentHttpRequest() throws Exception {

        CollegeStudent studentOne = new CollegeStudent("eric", "roby", "eric@example.com");
        ...
        CollegeStudent verifyStudent = studentDao.findByEmailAddress("chad@example.com");
